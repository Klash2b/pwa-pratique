...
function loadTechnologies(technos) {
  fetch("https://us-central1-pwa-technos-47d96.cloudfunctions.net/getTechnos")
    .then((response) => {
...
if (navigator.serviceWorker) {
  ...
  navigator.serviceWorker
    ...
    .then((registration) => {
      ...
      const publicKey =
        "BA2IvwPQNHYNw9BKePJhoims8PftBL_VP0TtoezTTDcIiIx4AWZLPN9E8_LGOZccDW4ESEqxYPhk2LdJfhrUdII";
